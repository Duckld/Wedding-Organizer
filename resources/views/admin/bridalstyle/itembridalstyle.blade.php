    ...
    <div id="app">
                        ...
                        <li class="sidebar-item has-sub  active">
                            ...
                            <ul class="submenu active">
                                ...
                                <li class="sidebar-item has-sub active">
                                    <a href="#" class='sidebar-link'>
                                        <i class="bi bi-stack"></i>
                                        <span>Bridalstyle</span>
                                    </a>
                                    <ul class="submenu active">
                                        <li class="submenu-item">
                                            <a href="/admin/bridalstyle">Paket</a>
                                        </li>
                                        <li class="submenu-item active">
                                            <a href="/admin/itembridalstyle">Item</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="submenu-item">
        ...
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('itembridalstyle.store') }}" method="POST" enctype="multipart/form-data" >
                            @csrf
